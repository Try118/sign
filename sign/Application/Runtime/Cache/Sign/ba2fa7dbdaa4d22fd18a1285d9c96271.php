	...
	<body onload="init()">
		...
		<div class="wrapper">
					...
					<ul id="nav">
						...
						<li class="list">
							...
							<ul class="sub-menu opened" style="display: none;">
								...
								<li>
									<a href="../number/member-kiss.html">
						...
						<li class="list">
							...
							<ul class="sub-menu">
								<li>
									<a href="<?php echo U('Roommain/memberdel');?>">
							...
							<ul class="sub-menu" style="display:none">
								<!--<li>
									<a href="./echarts1.html">
										<i class="iconfont">&#xe6a7;</i> 拆线图
									</a>
								</li>
								<li>
									<a href="./echarts2.html">
										<i class="iconfont">&#xe6a7;</i> 柱状图
									</a>
								</li>
								<li>
									<a href="./echarts3.html">
										<i class="iconfont">&#xe6a7;</i> 地图
									</a>
								</li>
								<li>
									<a href="./echarts4.html">
										<i class="iconfont">&#xe6a7;</i> 饼图
									</a>
								</li>
								<li>
									<a href="./echarts5.html">
										<i class="iconfont">&#xe6a7;</i> k线图
									</a>
								</li>
								<li>
									<a href="./echarts6.html">
										<i class="iconfont">&#xe6a7;</i> 仪表图
									</a>
								</li>-->
								<!--<li>
									<a href="http://echarts.baidu.com/examples.html">
										<i class="iconfont">&#xe6a7;</i> 更多案例
									</a>
								</li>-->
							</ul>
						</li>
			...
			<div class="page-content">
				<div class="content">
					<!-- 右侧内容框架，更改从这里开始 -->
					<form class="layui-form xbs" action="<?php echo U('Basicmain/search_member');?>" method="post">
                    ...
                    <div class="layui-input-inline xbs768">
                      <input class="layui-input" placeholder="截止日" id="LAY_demorange_e">
								...
								<div class="layui-input-inline">
									<input type="text" name="card" placeholder="请输入一卡通" autocomplete="off" class="layui-input">
								</div>
					...
					<xblock><button class="layui-btn layui-btn-danger" onclick="delAll()" style="float: left;"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" style="float: left;" onclick="member_add('添加用户','member_add.html','600','500')"><i class="layui-icon">&#xe608;</i>添加</button>
						<form  class="layui-btn" enctype="multipart/form-data"  style="float: left;" action="<?php echo U('Basicmain/add_batch');?>" method="post">
						...
						<tbody>
							...
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
									...
									<td class="td-manage">
										...
										<a title="编辑" href="javascript:;" onclick="member_edit('编辑','<?php echo U('Basicmain/member_edit');?>?id=<?php echo ($vol["id"]); ?>','4','','510')" class="ml-5" style="text-decoration:none">
											<i class="layui-icon">&#xe642;</i>
										</a>
										<!--<a style="text-decoration:none" onclick="member_password('修改密码','member-password.html','10001','600','400')" href="javascript:;" title="修改密码">
										<i class="layui-icon">&#xe631;</i>
									</a>-->
										<a title="删除" href="<?php echo U('Basicmain/member_delete');?>?id=<?php echo ($vol["id"]); ?>" onclick="member_del(this,'1')" style="text-decoration:none">
											<i class="layui-icon">&#xe640;</i>
										</a>
									</td>
